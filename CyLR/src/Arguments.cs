...
namespace CyLR
{
    ...
    {
        private const string BaseHelpMessage =
        ...
        public readonly bool AllAppData = false;

        public Arguments(IEnumerable<string> args)
        {
            ForceNative =
                !Platform
                    .SupportsRawAccess(); //default this to whether or not the platform supports raw access
                ...
                switch (argEnum.Current)
                {
                    ...
                    case "-o":
                        throw new ArgumentException(
                            "-o is no longer supported, please use -od instead.");
            ...
            if (!HelpRequested)
            {
                ...
                {
                    throw new ArgumentException(
                        "The flags -u, -p, and -s must all have values to continue.  Please try again.");
                }
        ...
        public string GetHelp(string topic)
        {
            ...
            {
                var helpText = new StringBuilder(string.Format(BaseHelpMessage,
                    Version.GetVersion(), AppDomain.CurrentDomain.FriendlyName)).AppendLine();
    ...
    internal static class ArgumentExtentions
    {
        ...
        public static bool GetArgumentParameter(this IEnumerator<string> arguments,
